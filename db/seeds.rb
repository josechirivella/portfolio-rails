...
Project.create!(title: 'MATI Website', description: 'Redesigned the MATI Website from scratch, wrote the code and architecture with Ruby on Rails and AngularJS', advance_description:"Before the current and awesome MATI Website, this one was a template from squarespace... The CEO wanted something more functional and custom, so I deliver this awesome website!", live_url: 'https://matienergy.com', source_code_link: '', background_image_url: 'https://storage.googleapis.com/portfolio-assets/portfolio/matienergy.png')
Project.create!(title: 'Question Box', description: 'Homework for The Iron Yard', advance_description: "Made an StackOverfow v2.0 with better functionality and more...", live_url: 'https://questionbox.herokuapp.com/', source_code_link: 'https://github.com/JoseChirivella14/question_box', background_image_url: 'https://storage.googleapis.com/portfolio-assets/portfolio/questionbox.png')
Project.create!(title: 'Trimmer', description: 'Homework from The Iron Yard - Ruby on Rails class', advance_description: "Using Twitter Gem and Oauth Autorization to enlist your followers and see who of your followers it's tweeting more and you can mute them and / or unfollow them.", live_url: 'https://questionbox.herokuapp.com/', source_code_link: 'https://github.com/JoseChirivella14/question_box', background_image_url: 'https://storage.googleapis.com/portfolio-assets/portfolio/trimmer.png')
