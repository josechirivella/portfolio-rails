...
# Project.create!(title: 'Trimmer', description: 'Homework for The Iron Yard', live_url: 'https://questionbox.herokuapp.com/', source_code_link: 'https://github.com/JoseChirivella14/question_box', background_image_url: 'https://s3.amazonaws.com/jose-images-personal/portfolio/question-box.png')
# Project.create!(title: 'Gymlion', description: 'Homework for The Iron Yard', live_url: 'https://gymlion.com/', source_code_link: 'https://github.com/JoseChirivella14/question_box', background_image_url: 'https://s3.amazonaws.com/jose-images-personal/portfolio/question-box.png')