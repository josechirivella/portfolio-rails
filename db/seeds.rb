...
Project.destroy_all
Project.create!(title: 'Gymlion', description: 'An app to facilitate the searching of a gym, yoga class and many more', advance_description: 'Using Node.js, Bootstrap and MongoDB', live_url: 'https://gymlion.com/', source_code_link: '', background_image_url: 'https://s3.amazonaws.com/jose-images-personal/portfolio/question-box.png')
...
Project.create!(title: '', description:'', advance_description: '', live_url: '', source_code_link:'', background_image_url:'')
Project.create!(title: 'MATI Website', description: 'Redesigned the MATI Website from scratch, build the code and architecture with Ruby on Rails and AngularJS', advance_description:"", live_url: 'http://matienergy.com', source_code_link: '', background_image_url: 'https://s3.amazonaws.com/jose-images-personal/portfolio/mati-website.png')
